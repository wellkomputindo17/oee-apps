                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <input type="text" required autocomplete="off"
                                        ...
                                        name="no_mesin" id="no_mesin" value="{{ old('no_mesin', $mesin->no_mesin) }}">
                                    @error('no_mesin')
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" value="{{ old('year', $mesin->year) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" value="{{ old('type', $mesin->type) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" value="{{ old('origin', $mesin->origin) }}"
