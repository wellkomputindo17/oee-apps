        ...
        <div class="col-md-12">
            <div class="card shadow">
                <div class="card-header py-2">
                    ...
                    <a href="javascript:void(0)" data-link="{{ route('unplan.store') }}" data-action="add" data-type="parent"
                                    ...
                                    <label for="menu{{ $key + 1 }}">
                                        ...
                                        <a href="javascript:void(0)" class="float-right">
                                            <span class="badge badge-danger btn-action"
                                                data-link="{{ route('unplan.store') }}" data-type="child"
                                        ...
                                        <a href="javascript:void(0)" class="float-right">
                                            <span class="badge badge-success btn-action"
                                                data-link="{{ route('unplan.store') }}" data-type="child" data-action="edit"
                                                data-id_sub="{{ $item->id }}">
                                        ...
                                        <a href="javascript:void(0)" class="float-right">
                                            <span class="badge badge-primary btn-action"
                                                data-link="{{ route('unplan.store') }}" data-type="child" data-action="add"
                                                data-id_sub="{{ $item->id }}">
                                ...
                                <li id="menu{{ $key + 1 }}">
                                    <a>
                                        ...
                                        <span class="badge badge-primary btn-action" style="cursor: pointer;"
                                            data-link="{{ route('unplan.store') }}" data-action="add" data-type="child"
                                            data-id_sub="{{ $item->id }}">
                                            <i class="fas fa-plus"></i>
                                        </span>
                                        <span class="badge badge-success btn-action" style="cursor: pointer;"
                                            data-link="{{ route('unplan.store') }}" data-action="edit" data-type="child"
                                            data-id_sub="{{ $item->id }}">
                                            <i class="fas fa-edit"></i>
                                        </span>
                                        <span class="badge badge-danger btn-action" style="cursor: pointer;"
                                            data-link="{{ route('unplan.store') }}" data-action="delete" data-type="child"
                                            data-id_sub="{{ $item->id }}">
                                            <i class="fas fa-trash"></i>
                                        </span>
                                    </a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label for="jenis_downtime" class="col-md-5">Unplan Downtime Name<span
        ...
        $(function() {
            ...
            $(document).on("click", ".btn-action", function(e) {
                ...
                if (action == 'add') {
                    ...
                    if (type == 'parent') {
                        $(".form-modal").find(".modal-title").html("Form Add Parent Unplan Downtimes");
                    } else {
                        $(".form-modal").find(".modal-title").html("Form Add Child Unplan Downtimes");
                    }
                    ...
                    let url = '{{ route('unplan.show', ':id') }}';
                    url = url.replace(':id', `${id_sub}`);

                    $('.form-modal').modal('show');

                    $(".form-modal").find(".modal-title").html("Form Edit Unplan Downtimes");
