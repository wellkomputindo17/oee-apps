    ...
    d3.timeline = function () {
      ...
      var hover = function () {},
        mouseover = function (d, i, datum) {
          // console.log([d.starting_time, d.ending_time]);
          const datetime_start = new Date(d.starting_time);
          const datetime_stop = new Date(d.ending_time);
          const date_start = new Date(d.starting_date * 1000);
          const date_stop = new Date(d.ending_date * 1000);

          let hours_start = "0" + datetime_start.getHours();
          let minutes_start = "0" + datetime_start.getMinutes();
          let seconds_start = "0" + datetime_start.getSeconds();

          let hours_stop = "0" + datetime_stop.getHours();
          let minutes_stop = "0" + datetime_stop.getMinutes();
          let seconds_stop = "0" + datetime_stop.getSeconds();

          // Will display time in 10:30:23 format
          let startFormattedTime = `${date_start.toLocaleDateString()} ${hours_start.substr(-2)}:${minutes_start.substr(-2)}:${seconds_start.substr(-2)}`;
          let stopFormattedTime = `${date_stop.toLocaleDateString()} ${hours_stop.substr(-2)}:${minutes_stop.substr(-2)}:${seconds_stop.substr(-2)}`;
          ...
          Tooltip
          .html(`
          <p class="text-center m-0 p-0">${d.name}</p>
          Event : ${d.event} <br>
          Start Time : ${startFormattedTime}  <br>
          Stop Time : ${stopFormattedTime} 
          `)
        ...
        g.each(function (d, i) {
          ...
          d.forEach(function (datum, index) {
            ...
            g.selectAll("svg")
              ...
              .on("mouseover", function (d, i, datum) {
                mouseover(d, i, datum);
              })
